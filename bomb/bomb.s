...
00000000004010f4 <phase_6>:
  ...
  // -------------------------------------------------------------------
  // every value should be no more than 6, and be different with each other.
  ...
  // -------------------------------------------------------------------
  // change the values in the vector to their 7's complement.
  ...
  // -------------------------------------------------------------------
  // assign the pointers.
  40116f:	be 00 00 00 00       	mov    $0x0,%rsi
  ...
  // -----------------------------------------------------------------
  // construct the linked list (assign the address of the next node).
  ...
  4011d9:	00 
  // ----------------------------------------------------------------
  // check the monotonicity of the linked list.
